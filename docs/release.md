...
The current source release is **v1.2.0**. Generated APK and Windows binaries should be attached to the GitHub Release rather than committed to the source tree.
